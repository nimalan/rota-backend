...
# FINAL-VERSION-CHECK-BACKEND-V10
load_dotenv()
...
def request_holiday():
    ...
    new_holiday = Holiday(user_id=data['user_id'], start_date=datetime.fromisoformat(data['start_date']).date(), end_date=datetime.fromisoformat(data['end_date']).date(), notes=data.get('notes'))
